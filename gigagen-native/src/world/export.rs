...
#[no_mangle]
unsafe extern "C" fn create_world(center: Vec3, view_dist: u8, chunk_size: f32) -> *mut GigaWorld {
...
#[no_mangle]
unsafe extern "C" fn set_world_data(world: *mut GigaWorld, view_dist: u8, chunk_size: f32) {
    (*world).set_data(view_dist, chunk_size);
}
